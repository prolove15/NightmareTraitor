...
{
    public class Controller_Gp : MonoBehaviour
    {
        ...
        //-------------------------------------------------- static fields
        public static Controller_Gp instance;
        ...
        [ReadOnly] public PlayerManager pManager_Cp;
        ...
        public Player_M localPlayer_Cp { get { return pManager_Cp.localPlayer_Cp; } }
        ...
        void SetComponents()
        {
            ...
            pManager_Cp = PlayerManager.instance;
        ...
        {
            if (onlineHandler_Cp.isMultiMode)
            {
            ...
            pManager_Cp.Init();
            yield return new WaitUntil(() => pManager_Cp.mainGameState == PlayerManager.GameState_En.Inited);
